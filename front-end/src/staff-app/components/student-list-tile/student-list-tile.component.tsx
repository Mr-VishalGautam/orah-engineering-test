...
export const StudentListTile: React.FC<Props> = ({ isRollMode, student ,studentStateList}) => {
  ...
  return (
    <S.Container>
      ...
      {isRollMode && (
        <S.Roll>
          <RollStateSwitcher studentStateList={studentStateList} studentId={PersonHelper.getId(student)} />
        </S.Roll>
      )}
    </S.Container>
  )
