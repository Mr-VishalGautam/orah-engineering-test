...
interface Props {
  ...
  stateCount: { present: number; absent: number; late: number }
  totalStudents: any
  filterByState:any
}

export const ActiveRollOverlay: React.FC<Props> = (props) => {
  const { isActive, onItemClick, totalStudents, stateCount,filterByState } = props
        ...
        <div>
          ...
          filterByState={filterByState}
            stateList={[
              ...
              { type: "present", count: stateCount.present },
              { type: "late", count: stateCount.late },
              { type: "absent", count: stateCount.absent },
            ]}
          />
